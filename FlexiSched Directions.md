...
1. Ensure you've received three COGNOS reports in your Gmail:  
   ...
   - "A new version of My Student CY List \- Courses, Teacher & Room is available"  
...
3. Add any necessary comments in **Column L** (Comments)  
...
| :---- | :---- | :---- |
| A-L | FlexiSched data | Manual entry (paste from FlexiSched) |
| M | Attendance Code | Auto-populated from BHS attendance |
| N | 2nd Period Teacher | Auto-populated from 2nd period default |
...
1. **Check cell A1 notes:** After importing, check cell A1 in each sheet for import status and timestamps  
2. **Review skippers:** Before sending notifications, review the Mail Out sheet to ensure all skippers are legitimate  
3. **Add context in comments:** Use Column L to add any relevant context before sending parent notifications  
4. **Keep sheets organized:** The system automatically creates dated sheets, so you have a historical record, but you can delete the ones you do not need anymore
...
- Make sure you've pasted FlexiSched data into columns A-L before running enrichment
...
For detailed technical documentation, reference this project on GitHub at: [https://github.com/AlvaroGomezMartinez/flexischedule-project](https://github.com/AlvaroGomezMartinez/flexischedule-project)
